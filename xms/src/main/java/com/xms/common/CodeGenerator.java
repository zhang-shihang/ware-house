...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        //注意添加+"/xms"定位到xms文件夹下
        String projectPath = System.getProperty("user.dir") + "/xms";
        ...
        // ⼀、修改数据源
        dsc.setUrl("jdbc:mysql://localhost:3306/xms?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=GMT%2B8");
